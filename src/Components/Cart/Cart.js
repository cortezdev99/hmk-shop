...
export default () => {
  ...
  const handleRemoveProduct = (id) => {
    const cartProductWrapper = document.getElementById(
      `cart-product-wrapper-${id}`
    );
    const checkoutBtnElm = document.getElementById(
      "cart-product-checkout-wrapper"
    );
  ...
  useEffect(() => {
    const cartWrapperElement = document.getElementById("cart-wrapper");
    const checkoutBtnElement = document.getElementById(
      "cart-product-checkout-wrapper"
    );
    const productContainerElement = document.getElementById(
  ...
  return (
    <div className="cart-container">
      <div className="cart-wrapper" id="cart-wrapper">
        <div
          className="cart-heading-wrapper"
          style={{
        ...
        <div className="cart-free-shipping-header">
          {subtotal >= 100
            ? "You're eligable for free shipping!".toUpperCase()
            : 100 - subtotal === 100
            ? `Spend $100 and recieve free shipping!`.toUpperCase()
            : `Spend $${
                100 - subtotal
              } more and recieve free shipping!`.toUpperCase()}
        </div>
                  ...
                  <div className="cart-product-right-column-wrapper">
                    ...
                    <div className="cart-product-color-and-size-wrapper">
                      <div className="cart-product-color-and-size">
                        {Object.values(product[2])[0]} /{" "}
                        {Object.values(product[1])[0]}
                      </div>
                    </div>
                    ...
                    <div className="cart-product-quantity-container">
                      <div className="cart-product-quantity-left-column-wrapper">
                        <button
                          ...
                          onClick={() =>
                            handleQuantityButtonClick("minus", productIdx)
                          }
                        >
                        ...
                        <button
                          ...
                          className="cart-product-quantity-toggle"
                          onClick={() =>
                            handleQuantityButtonClick("plus", productIdx)
                          }
                        >
        ...
        <div
          className="cart-product-checkout-wrapper"
          id="cart-product-checkout-wrapper"
          style={
            {
